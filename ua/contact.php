...
$subject = 'Повідомлення з контактної форми | PlaySpace';
...
$headers = "Повідомлення з контактної форми | PlaySpace\r\n";
$body .= "Content-type: text/html\r\n"; /* For mail client to recognize code and not display it as plain text in an email received */
$body = <<<EOD
Вітаю,

Мене звати $guest_name,
а моя електронна адреса - $guest_email
Хочу сказати ось що: 
...
<title>Повідомлення відправлено! | PlaySpace</title>
...
<div class="story-intro" style="background: white;">
  ...
  <br>
  <a class="go-back" style="color:white; font-size:1rem; height:auto;" href="../ua/index.html">на головну сторінку &#9654;</a> 
